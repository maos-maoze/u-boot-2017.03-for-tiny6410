...
//ADD BY MAO
#define MULCON				(ELFIN_UART_BASE + ULCON_OFFSET)
#define MUCON				(ELFIN_UART_BASE + UCON_OFFSET)
#define MUFCON				(ELFIN_UART_BASE + UFCON_OFFSET)
#define MUMCON				(ELFIN_UART_BASE + UMCON_OFFSET)
#define MUTRSTAT			(ELFIN_UART_BASE + UTRSTAT_OFFSET)
#define MUERSTAT			(ELFIN_UART_BASE + UERSTAT_OFFSET)
#define MUFSTAT				(ELFIN_UART_BASE + UFSTAT_OFFSET)
#define MUMSTAT				(ELFIN_UART_BASE + UMSTAT_OFFSET)
#define MUTXH				(ELFIN_UART_BASE + UTXH_OFFSET)
#define MURXH				(ELFIN_UART_BASE + URXH_OFFSET)
#define MUBRDIV				(ELFIN_UART_BASE + UBRDIV_OFFSET)
#define MUDIVSLOT			(ELFIN_UART_BASE + UDIVSLOT_OFFSET)
#define MUINTP				(ELFIN_UART_BASE + UINTP_OFFSET)
#define MUINTSP				(ELFIN_UART_BASE + UINTSP_OFFSET)
#define MUINTM				(ELFIN_UART_BASE + UINTM_OFFSET)
